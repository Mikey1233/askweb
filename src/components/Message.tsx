    ...
    >
      <div className="p-6">
        <div className="max-w-3xl mx-auto flex items-start gap-2.5">
          <div
            className={cn(
              "size-10 shrink-0 aspect-square rounded-full border border-zinc-900 flex justify-center items-center"
            ,{
                "bg-blue-700 border-blue-700 text-zinc-200": isUserMessage
            })}
          >
          ...
          <div className="flex flex-col ml-6 w-full">
           ...
           <p className="text-sm font-normal text-gray-900 py-2.5 dark:text-white">{content}</p>
          </div>
        </div>
      </div>
    </div>
